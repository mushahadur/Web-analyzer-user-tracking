...
var visitorUpDown = document.getElementById("visitorUpDown");
...
// new
var myChart21 = new Chart(visitorUpDown, {
    type: 'bar',
    data: {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
        datasets: [{
            label: 'Visit Up Rate',
            backgroundColor: "rgba(7,156,238,0.8)",
            borderColor: "rgb(6,133,224)",
            borderWidth: 1,
            data: ["20", "30", "40", "50", "60", "70", "80"],
        }, {
            label: 'Visit Down Rate',
            backgroundColor: "rgba(215,28,13,0.8)",
            borderColor: "rgb(229,8,57)",
            borderWidth: 1,
